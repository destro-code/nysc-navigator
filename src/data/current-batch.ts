export const CURRENT_BATCH_INFO = {
  batch: "2026 Batch B",
  stream: "Stream II",
  orientationStart: "2026-08-05",
  orientationEnd: "2026-08-25",
  ...
  notes: [
    ...
    "Current NYSC guidance: corps members should remain politically neutral and should not use their NYSC identity or social platforms for political campaigns, misinformation, or irresponsible sharing of AI-generated content.",
  ],
} as const;
